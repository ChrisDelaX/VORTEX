...
%%% added by Christian Delacroix for reversed axes (2013)
...
xLabPosCurr = get(get(gca,'XLabel'),'Position');
yLabPosCurr = get(get(gca,'YLabel'),'Position');
                            ...
                            case 'bottom'
                                if yReverseFlag==0
                                    hText = text(...
                                        ...
                                        'Interpreter','latex',...
                                        'FontSize', fontSize);
                                elseif yReverseFlag==1 % reverse axis
                                    hText = text(...
                                        xFig2DatCurr(xDat2FigAxis(xLimit(2))),...
...
if xReverseFlag
    ...
    set(get(gca,'ylabel'),'position',[2*xLimitCurr(1)+diff(xLimitCurr)-yLabPosCurr(1) 2*yLimitCurr(1)+diff(yLimitCurr)-yLabPosCurr(2) yLabPosCurr(3)])
end
if yReverseFlag
    set(gca,'YDir','reverse')
    set(get(gca,'xlabel'),'position',[2*xLimitCurr(1)+diff(xLimitCurr)-xLabPosCurr(1) 2*yLimitCurr(1)+diff(yLimitCurr)-xLabPosCurr(2) xLabPosCurr(3)])
end
