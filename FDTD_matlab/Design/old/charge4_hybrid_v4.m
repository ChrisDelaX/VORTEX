...
fillStart = 0.46; %0.2;%
fillEnd = 0.49; %0.5;%
nPeriods = 100;%30;%20;%60;%120;%40;%
nRLines = 6;%1;% % lines radius discretization (number)
nThLines = 8;%8;%  % lines theta discretization (number)
offset = 3;%2;%  % curves theta discretization (in periods!!!)

% Graphics, numerics
% ------------------
newFig
curveCellColor = myblue;%mygreen;%
...
axis(myaxis)
export_fig(fig,['curves_rMax=' num2str(rMax) '_nThLines=' num2str(nThLines) '_nRLines=' num2str(nRLines)],'-png')
