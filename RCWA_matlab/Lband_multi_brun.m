...
global Tin Rin T0 R0 absor TARG RARG Ttot Rtot TARGtot RARGtot Nghost NARGghost bandAR bandTAR nul_ghost nul_ghost_ARG nul_ideal
...
npts_pente = 1;%3;%5;%11;%
npts_F = 4;%24;%4;%8;%28;%42;%2;%1440;%
npts_d = 4;%24;%4;%8;%18;%27;%2;%878;%
...
title('L band [3.5 - 4.1 µm] - Null Depth (log_{10})','FontSize',fsz*1.5)
...
%str = sprintf('L band $$\\rightarrow \\Lambda_{max}= %3.3g \\mu m, \\:\\: \\alpha = %1.0g^{\\circ}$$.  ...
%For $$h = %3.3g \\mu m \\rightarrow \\frac{\\Lambda_{min}}{\\Lambda_{max}}= %3.2g \\rightarrow F = %3.2g $$',best_Lb_max,pente_deg,d,best_Lb_rat,best_F_moy);
