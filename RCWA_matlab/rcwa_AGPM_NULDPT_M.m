...
band = [4.5 5.1];%[11 13.2];%
bandtick = [4.5 4.6 4.7 4.8 4.9 5.0 5.1];%[11.0 11.5 12.0 12.5 13.0];%
...
l=legend(' AGPM-L1: F=0.36 h=4.2µm',' AGPM-L2: F=0.36 h=3.8µm');
%l=legend(' Optim1: F=0.47 h=5.2µm',' Optim2: F=0.4 h=4.3µm',' AGPM-L1: F=0.36 h=4.2µm',' AGPM-L2: F=0.36 h=3.8µm');
...
t=title(['     Null Depth (log_{10}) for \alpha = ',sprintf('%3.2f',pente_deg),'°']);%    with B = [',sprintf('%3.1f',lb_min),' - ',sprintf('%3.1f',lb_max),' µm] and \Lambda = ',sprintf('%3.2f',Lb),' µm']);
set(t,'Fontname',fnz,'FontSize',fsz*1.2,'FontWeight',fwz,'HorizontalAlignment','center')

print('-dpng', ['lognuldpt_M.png'], '-r300');
