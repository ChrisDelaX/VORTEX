...
npts_pente = 1;%3;%5;%11;%
npts_F = 24;%8;%28;%42;%2;%4;%1440;%
npts_d = 24;%8;%18;%27;%2;%4;%878;%
...
xlabel('Period (µm)','FontSize',fsz*1.2)
ylabel('Filling factor','FontSize',fsz*1.2)
title('K band [2 - 2.4 µm]','FontSize',fsz*1.5)
%title('K band [2-2.4µm] - Null Depth (log_{10})','FontSize',fsz*1.5)
set(gca,'XTick',[0.66 0.7 0.74 0.78 0.82])
...
print('-depsc2',sprintf('Lb.vs.F_depth=%3.2f_angle=%3.2f.eps',d,pente_deg), '-r300')
print('-dpng',sprintf('Lb.vs.F_depth=%3.2f_angle=%3.2f.png',d,pente_deg), '-r300')
