...
AGPM_L1_null = nul_res_sp_b;
AGPM_L1_TE = tmp1;
AGPM_L1_TM = tmp2;

save(['AGPM_L1_slope_',sprintf('%3.2f',pente_deg),'.mat'])
...
band = [3.3 4.3];%[11 13.2];%
bandtick = [3.3 3.4 3.5 3.6 3.7 3.8 3.9 4.0 4.1 4.2 4.3];%[11.0 11.5 12.0 12.5 13.0];%
...
%set(gca,'YScale','log')
set(gca,'ylim',[.86 1],'ytick',[.86 .88 .9 .92 .94 .96 .98 1])
...
y1=plot(lb_t,AGPM_L1_TE,'b','linewidth',lwz);
y2=plot(lb_t,AGPM_L1_TM,'r','linewidth',lwz);
...
t=title(['     AGPM L1']);%    with B = [',sprintf('%3.1f',lb_min),' - ',sprintf('%3.1f',lb_max),' µm] and \Lambda = ',sprintf('%3.2f',Lb),' µm']);
set(t,'Fontname',fnz,'FontSize',fsz*1.2,'FontWeight',fwz,'HorizontalAlignment','center')

print('-dpng', ['AGPM_L1_TE_TM.png'], '-r300');
...
AGPM_L2_null = nul_res_sp_b;
AGPM_L2_TE = tmp1;
AGPM_L2_TM = tmp2;

save(['AGPM_L2_slope_',sprintf('%3.2f',pente_deg),'.mat'])
...
xlabel('Wavelength (\mum)','FontSize',fsz*1.2)
ylabel('Transmission','FontSize',fsz*1.2)
y1=plot(lb_t,AGPM_L2_TE,'b','linewidth',lwz);
y2=plot(lb_t,AGPM_L2_TM,'r','linewidth',lwz);
...
t=title(['     AGPM L2']);%    with B = [',sprintf('%3.1f',lb_min),' - ',sprintf('%3.1f',lb_max),' µm] and \Lambda = ',sprintf('%3.2f',Lb),' µm']);
set(t,'Fontname',fnz,'FontSize',fsz*1.2,'FontWeight',fwz,'HorizontalAlignment','center')

print('-dpng', ['AGPM_L2_TE_TM.png'], '-r300');
