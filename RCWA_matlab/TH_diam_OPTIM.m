...
pente=rad(2.75);
L=16;
d=13.8587;%13.3580;%13.7315;%13.5489;%13.9565;%14.3957;%
nlb=81;
% nlb=11;%
% x0=[d];
...
tit=title('N-band AGPM  [11-13.2 µm]  with \Lambda = 4.6 µm,  F = 40%,  h = 13.8 µm  and  \alpha = 2.75°');
...
print('-depsc2',sprintf('TH_diam_a2_1.eps'), '-r300')
...
set(leg,'Fontname',fnz,'FontWeight',fwz,'FontSize',fsz,'location','north')
set(leg,'box','on','linewidth',lwz)
tit=title('F = 40%,  h = 13.8 µm  and  \alpha = 2.75°');
set(tit,'Fontname',fnz,'FontSize',fsz,'FontWeight','bold','HorizontalAlignment','right')
print('-depsc2',sprintf('TH_diam_a2_2.eps'), '-r300')
