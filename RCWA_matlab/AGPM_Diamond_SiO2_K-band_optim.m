...
Lb=0.768;
Lb_min=0.65;Lb_max=0.85;

%Epaisseurs
d=3.223;%3.94;%
d_min=12.5;d_max=13.5;
d_AR=0.336;
...
for i=1:npts
    ...
    [x,fval,exitflag] = fminsearch(@null_opt,x0,optimset('MaxIter',15,'Display','iter','TolX',1e-6,'TolFun',1e-6));
...
toc
save AGPM_Kband_alpha=4.3_optim.mat
