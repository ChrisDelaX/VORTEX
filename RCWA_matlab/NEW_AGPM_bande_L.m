...
% hold on
% 
% nulldepth = subplot(1,2,1);
% title('AGPM Diamond L-band')
% [b]=plot(Xparam,nulldpt,'Marker','o');
% set(b,'Linewidth',2) 
% xlabel('Total Grating thickness (\mum)','FontSize',16,'FontWeight','bold')
% title('Mean Null Depth','FontSize',16,'FontWeight','bold')
% axis square
% set(gca,'YScale','log')
% set(gca,'FontSize',16)
% set(gca,'FontWeight','bold')
% 
% ParamY1 = subplot(1,2,2);
% [c]=plot(Xparam,Yparam(:,1),'Marker','o');
% set(c,'Linewidth',2) 
% xlabel('Total Grating thickness (\mum)','FontSize',16,'FontWeight','bold')
% title('Filling factor','FontSize',16,'FontWeight','bold')
% set(gca,'FontSize',16)
% set(gca,'FontWeight','bold')
% %set(gca,'Ytick',[0 2e5 4e5 6e5 8e5 1e6])
...
% 
% %nulldepth = subplot(1,2,1);
% title('Mean Null Depth')
% [b]=plot(Xparam,nulldpt,'Marker','o');
% set(b,'Linewidth',2) 
% xlabel('Filling factor','FontSize',16,'FontWeight','bold')
% title('Mean Null Depth','FontSize',16,'FontWeight','bold')
% axis square
% set(gca,'YScale','log')
% set(gca,'FontSize',16)
...
% [b]=plot(Xparam,nulldpt,'Marker','o');
% set(b,'Linewidth',2) 
% xlabel('Slope (°)','FontSize',16,'FontWeight','bold')
% title('Mean Null Depth','FontSize',16,'FontWeight','bold')
% axis square
% set(gca,'YScale','log')
% set(gca,'FontSize',16)
