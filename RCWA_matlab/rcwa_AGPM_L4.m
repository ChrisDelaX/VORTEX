...
lb_min=4.5;%3.4;%3.25;%3.5;%
lb_max=5;%5.5;%4.25;%4.1;%
nlb=81;%11;%
...
y4=plot(lb_t,Trans_tmp4,'r-','linewidth',lwz);
...
print('-depsc2',sprintf('trans_M-band.eps'), '-r300');
...
set(gca,'XLim',band)%,'xtick',bandtick)
set(gca,'YScale','log')
set(gca,'ylim',[.001 .1])%,'ytick',[.4 .5 .6 .7 .8 .9 1])
set(gca,'Fontname',fnz,'FontSize',fsz,'FontWeight',fwz)
set(gca,'XMinorTick','on')
set(gca,'YMinorTick','on')
xlabel('Wavelength (\mum)','FontSize',fsz*1.2)
...
print('-depsc2',sprintf('null_M-band.eps'), '-r300');
